...
Always wanted to move the display to Graana but never got around to it, but I've seen they have a sql plugin now, or CSV. Haven't tried.

Discussion - https://forums.servethehome.com/index.php?threads/zfs-pool-test.40314/

# Maybe better read in Raw format. GitHub Readme formating butchers this
